// Usage: npm run seed
// Populates MongoDB (MONGODB_URI in .env.local) with the initial 4-product
// catalog so the storefront and admin dashboard have real, shared data.
...
const products = [
  {
    ...
    description: {
      en: "Stay completely dry in any downpour with our premium two-piece rain suit. Built from 100% waterproof, ripstop fabric with sealed seams, this suit includes a hooded jacket and matching trousers designed for daily commuters, bikers, and outdoor workers.",
      ur: "ہمارے پریمیم ٹو پیس رین سوٹ کے ساتھ کسی بھی بارش میں مکمل خشک رہیں۔",
    },
    features: [
      ...
      { en: "Reinforced main pocket, storm flap over buttons", ur: "مضبوط مرکزی جیب" },
    ],
    price: 2799,
    compareAtPrice: 3499,
    ...
    reviewCount: 3,
    reviews: [
      { id: "r1", customerName: "Hamza R.", rating: 5, comment: "Kept me completely dry on the bike during heavy rain. Great stitching quality.", approved: true, createdAt: "2026-07-10T10:00:00.000Z" },
      { id: "r2", customerName: "Ayesha K.", rating: 4, comment: "Good fit, hood could be a little bigger for helmet use.", approved: true, createdAt: "2026-07-15T10:00:00.000Z" },
      { id: "r3", customerName: "Bilal S.", rating: 5, comment: "Excellent value, delivered in 3 days.", approved: true, createdAt: "2026-07-20T10:00:00.000Z" },
    ],
    isFeatured: true,
  ...
  },
  {
    ...
    description: {
      en: "Shield your motorcycle from rain, dust, UV rays, and scratches with this heavy-duty, double-stitched cover. Fits standard bikes, sports bikes, scooters, and cruisers, and folds down into its own carry pouch.",
      ur: "اپنی موٹر سائیکل کو بارش، دھول اور خراشوں سے بچائیں۔",
    },
    features: [
    ...
    reviewCount: 2,
    reviews: [
      { id: "r1", customerName: "Usman T.", rating: 5, comment: "Fits my sports bike perfectly, no water gets through at all.", approved: true, createdAt: "2026-07-05T10:00:00.000Z" },
      { id: "r2", customerName: "Fatima N.", rating: 5, comment: "Strong material, straps keep it from flying off in wind.", approved: true, createdAt: "2026-07-18T10:00:00.000Z" },
    ],
    isFeatured: true,
  ...
  },
  {
    ...
    description: {
      en: "Give your car complete outdoor protection with this premium cover, engineered from strong, durable fabric with a gold piping trim. Waterproof, UV-resistant, dust-proof, and scratch-resistant.",
      ur: "اپنی گاڑی کو مکمل آؤٹ ڈور تحفظ دیں۔",
    },
    features: [
    ...
    reviewCount: 2,
    reviews: [
      { id: "r1", customerName: "Adnan M.", rating: 5, comment: "Premium quality, exact fit for my sedan. Worth the price.", approved: true, createdAt: "2026-07-08T10:00:00.000Z" },
      { id: "r2", customerName: "Sana Q.", rating: 5, comment: "The gold trim looks classy and the straps hold it firmly.", approved: true, createdAt: "2026-07-22T10:00:00.000Z" },
    ],
    isFeatured: true,
  ...
  },
  {
    ...
    description: {
      en: "Protect your mattress and enhance your sleep with a soft, quilted, 100% waterproof bedsheet cover. Machine washable and easy to wipe clean, ideal for kids, elders, and pets.",
      ur: "اپنے گدے کی حفاظت کریں اور نیند بہتر بنائیں۔",
    },
    features: [
    ...
    reviewCount: 1,
    reviews: [
      { id: "r1", customerName: "Mariam A.", rating: 4, comment: "Very soft for a waterproof cover, no plastic crinkle sound at all.", approved: true, createdAt: "2026-07-25T10:00:00.000Z" },
    ],
    isFeatured: false,
...
async function seed() {
  ...
  for (const product of products) {
    ...
    console.log(`Seeded: ${product.name.en}`);
  }

  await db.collection("settings").updateOne(
    { _key: "site" },
    { $setOnInsert: { _key: "site" } },
    { upsert: true }
  );
